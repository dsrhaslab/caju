...
public:
    ...
    Status(State s, R return_value_arg) : state(s), return_value(std::move(return_value_arg)) {} 
    Status(R return_value_arg) : state(SUCCESS), return_value(std::move(return_value_arg)) {}
